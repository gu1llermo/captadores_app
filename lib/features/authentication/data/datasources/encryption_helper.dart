...
class EncryptionHelper {
  ...
  /// Método de utilidad para debugging - NO logs de datos sensibles
  void logEncryptionStatus(String comando, Map<String, dynamic> parametros) {
    if (containsSensitiveData(parametros)) {
      print('[$comando] Datos sensibles detectados y procesados');
    } else {
      print('[$comando] Sin datos sensibles');
    }
  }
}